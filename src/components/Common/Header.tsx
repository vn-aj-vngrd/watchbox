...
const Header = ({ session }: Props) => {
  return (
    <header className="sticky top-0 z-10 flex h-14 items-center justify-between border-b border-gray-100 bg-white px-5 py-1.5 dark:border-grayColor dark:bg-darkerColor">
