...
const terms_conditions = () => {
  return (
    <div>
      Terms and Conditions Welcome to WatchBox! These terms and conditions
      outline the rules and regulations for the use of NextDevs's Website,
      located at https://watchbox.vercel.app/. By accessing this website we
      assume you accept these terms and conditions. Do not continue to use
      WatchBox if you do not agree to take all of the terms and conditions
      stated on this page. The following terminology applies to these Terms and
      Conditions, Privacy Statement and Disclaimer Notice and all Agreements:
      ...
      same. Cookies We employ the use of cookies. By accessing WatchBox, you
      agreed to use cookies in agreement with the NextDevs's Privacy Policy.
      Most interactive websites use cookies to let us retrieve the user’s
      details for each visit. Cookies are used by our website to enable the
      functionality of certain areas to make it easier for people visiting our
      website. Some of our affiliate/advertising partners may also use cookies.
      License Unless otherwise stated, NextDevs and/or its licensors own the
      intellectual property rights for all material on WatchBox. All
      intellectual property rights are reserved. You may access this from
      WatchBox for your own personal use subjected to restrictions set in these
      terms and conditions. You must not: Republish material from WatchBox Sell,
      rent or sub-license material from WatchBox Reproduce, duplicate or copy
      material from WatchBox Redistribute content from WatchBox This Agreement
      shall begin on the date hereof. Our Terms and Conditions were created with
      the help of the Free Terms and Conditions Generator. Parts of this website
      offer an opportunity for users to post and exchange opinions and
      information in certain areas of the website. NextDevs does not filter,
      edit, publish or review Comments prior to their presence on the website.
      Comments do not reflect the views and opinions of NextDevs,its agents
      ...
      laws, NextDevs shall not be liable for the Comments or for any liability,
      ...
      NextDevs reserves the right to monitor all Comments and to remove any
      ...
      licenses and consents to do so; The Comments do not invade any
      ...
      or promote business or custom or present commercial activities or unlawful
      activity. You hereby grant NextDevs a non-exclusive license to use,
      reproduce, edit and authorize others to use, reproduce and edit any of
      your Comments in any and all forms, formats or media. Hyperlinking to our
      Content The following organizations may link to our Website without prior
      written approval: Government agencies; Search engines; News organizations;
      Online directory distributors may link to our Website in the same manner
      as they hyperlink to the Websites of other listed businesses; and System
      ...
      hyperlink to our Web site. These organizations may link to our home page,
      to publications or to other Website information so long as the link: (a)
      is not in any way deceptive; (b) does not falsely imply sponsorship,
      endorsement or approval of the linking party and its products and/or
      services; and (c) fits within the context of the linking party’s site. We
      may consider and approve other link requests from the following types of
      ...
      visibility of the hyperlink compensates the absence of NextDevs; and (d)
      ...
      our website, you must inform us by sending an e-mail to NextDevs. Please
      ...
      NextDevs's logo or other artwork will be allowed for linking absent a
      ...
      Reservation of Rights We reserve the right to request that you remove all
      links or any particular link to our Website. You approve to immediately
      remove all links to our Website upon request. We also reserve the right to
      amen these terms and conditions and it’s linking policy at any time. By
      continuously linking to our Website, you agree to be bound to and follow
      these linking terms and conditions. Removal of links from our website If
      you find any link on our Website that is offensive for any reason, you are
      free to contact and inform us any moment. We will consider requests to
      ...
      website is kept up to date. Disclaimer To the maximum extent permitted by
      ...
      personal injury; limit or exclude our or your liability for fraud or
      fraudulent misrepresentation; limit any of our or your liabilities in any
      way that is not permitted under applicable law; or exclude any of our or
