...
describe('calculatePoint', () => {
  it('calculates point correctly', () => {
    ...
    const result = calculatePoint(canvasRect, scroll, infoPoint, componentHalf, componentFull, offset);
...
describe('resetCanvasSize', () => {
  it('resets canvas size correctly', () => {
    const canvasSizeRef = { current: { style: { width: 'auto', height: 'auto' } } } as React.RefObject<HTMLDivElement>;
    const canvasRef = { current: { scrollWidth: 100, clientWidth: 50, scrollHeight: 100, clientHeight: 50 } } as React.RefObject<HTMLDivElement>;
...
describe('scrollEdge', () => {
  it('scrolls edge correctly', () => {
    ...
    const canvasSizeRef = { current: { style: { width: '120px', height: 'auto' } } } as React.RefObject<HTMLDivElement>;
    const canvasRef = { current: { scrollWidth: 100, clientWidth: 50, scrollLeft: 0 } } as React.RefObject<HTMLDivElement>;
